        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap" id="Acolor">
                    ...
                    <a href="{{url('admin/banadmin')}}" class="Acolor">科技金融</a>
            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td class="tc">
                        	@if(($v->ban_state)=='1')
                                <a href="{{url('admin/banchangestate/'.$v->ban_id)}}" style="display:block;width:100%;text-align:center;">通过</a>
                            @else
