        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap" id="Acolor">
                    ...
                    <a href="{{url('admin/neeadmin')}}" class="Acolor">科技需求</a>
                    <a href="{{url('admin/hatadmin')}}">科技孵化</a>
                    <a href="{{url('admin/banadmin')}}">科技金融</a>
                    <a href="{{url('admin/assadmin')}}">科技评估</a>
                </div>
            </div>
            <!--快捷导航 结束-->
        </div>
            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td class="tc">{{$v->nee_method}}</td>
                        <td class="tc">{{$v->nee_author}}</td>
                        ...
                        <td class="tc">
                        	@if(($v->nee_state)=='1')
                                <a href="{{url('admin/neechangestate/'.$v->nee_id)}}" style="display:block;width:100%;text-align:center;">通过</a>
                            @else
