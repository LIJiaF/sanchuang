...
<script type="text/javascript" src="{{asset('resources/org/edit/script/jquery-1.6.4.js')}}"></script>
    ...
    <div class="result_wrap">
        <form action="{{url('admin/expert')}}" method="post">
            {{csrf_field()}}
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select name="exp_domain">
                                <option value="其他">其他</option>
                                <option value="产业技术">产业技术</option>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="exp_name">
                        </td>
                    </tr>
                    <tr>
                        <th><i class="require">*</i>头像：</th>
                        <td>
                            <input type="text" class="lg" name="exp_thumb">
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <img src="" id="exp_thumb_img" style="max-width:350px;max-height:100px;">
                        </td>
                    </tr>
                    <tr>
                        <th><i class="require">*</i>专家介绍：</th>
                        <td>
                            <textarea name="exp_content" style="resize:none;"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th></th>
