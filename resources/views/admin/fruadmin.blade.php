        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap" id="Acolor">
                    <a href="{{url('admin/fruadmin')}}" class="Acolor">科技成果</a>
            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td class="tc">
                        	@if(($v->fru_state)=='1')
                                <a href="{{url('admin/fruchangestate/'.$v->fru_id)}}" style="display:block;width:100%;text-align:center;">通过</a>
                            @else
