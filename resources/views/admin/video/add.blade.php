            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="vid_name">
                        </td>
                    </tr>
                    <tr>
                        <th><i class="require">*</i>视频缩略图：</th>
                        <td>
                            <input type="text" class="lg" name="vid_thumb">
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <img src="" id="vid_thumb_img" style="max-width:350px;max-height:100px;">
                        </td>
                    </tr>
                    <tr>
                        <th><i class="require">*</i>视频地址：</th>
                        <td>
                            <input type="text" class="lg" name="vid_src" value="http://">
                        </td>
                    </tr>
                    <tr>
                        <th></th>
