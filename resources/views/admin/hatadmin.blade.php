        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap" id="Acolor">
                    ...
                    <a href="{{url('admin/hatadmin')}}" class="Acolor">科技孵化</a>
            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td class="tc">
                        	@if(($v->hat_state)=='1')
                                <a href="{{url('admin/hatchangestate/'.$v->hat_id)}}" style="display:block;width:100%;text-align:center;">通过</a>
                            @else
